...
export default function GeneralSettings({ onChange }) {
  ...
  const dirty = form.domain !== data.settings.domain || form.publicHost !== data.settings.publicHost;
    ...
    <div className="stack">
      ...
      <div className="card">
        ...
        <div className="row" style={{ gap: 8 }}>
          ...
          {dirty && <button disabled={busy} onClick={() => setForm({ domain: data.settings.domain, publicHost: data.settings.publicHost })}>Reset</button>}
        </div>
